# Automation (Quick User Projects)

Automacoes opcionais para projetos que usam o Nébula Spec Kit no modo Quick.
...
3. Se o projeto sair de escopo Quick para Full, manter os mesmos scripts.
